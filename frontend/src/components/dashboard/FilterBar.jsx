...
// ─── Datos del modelo LightGBM V2 (reporte_optimizador_categorias.csv)
// Optimizados con F0.5-score — precisión > recall
const ESTRATEGIAS_MODELO = [
  ...
  },
  {
    ...
    label: '✅ BUY Aprobadas',
    type: 'veredicto',
    descripcion: 'Solo activos con Veredicto_V2 = BUY (Probabilidad ≥ 40% umbral modelo)',
  },
  {
    id: 'Recup. Rapida',
    label: '⚡ Recup. Rápida',
    ...
    retorno_trade: '+4.10%',
    total_trades: 323,
    descripcion: 'Tendencia alcista con corrección menor (EMA20 ≥ SMA50, sobre SMA200). Alta velocidad de recuperación.',
  },
  {
    id: 'Sweet Spot',
    label: '🎯 Sweet Spot',
    ...
    retorno_trade: '+3.85%',
    total_trades: 174,
    descripcion: 'Zona ideal de acumulación: fundamentos sólidos, corrección temporal, tendencia largo plazo intacta.',
  },
  {
    id: 'Cazador Dips',
    label: '🔥 Cazador Dips',
    ...
    retorno_trade: '+3.20%',
    total_trades: 212,
    descripcion: 'Caída agresiva (>35% drawdown 52W) + RSI 2D < 10. Alto riesgo, alta recompensa. Estrategia Connors.',
  },
  {
    ...
    retorno_trade: '+1.80%',
    total_trades: 378,
    descripcion: 'Tendencia bajista sin soporte. Máxima cautela. Solo para traders con alta tolerancia al riesgo.',
  },
];
